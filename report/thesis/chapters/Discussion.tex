\chapter{Discussion}
\label{Discussion}
This chapter contains the discussions about the implemented dynamic taint tracker, named WebTaint, and how well it performs. The chapter starts with a general discussion about the implementation and the result. This is then followed by \textit{\nameref{propagation}} discussions. Lastly is there two sections about \textit{\nameref{sss}} and \textit{\nameref{methev}}.
