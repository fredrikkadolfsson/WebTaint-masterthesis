\chapter{Discussion}
\label{Discussion}
\textit{This chapter contains discussions regarding the implemented dynamic taint tracker, named WebTaint, and how well it performs. Chapter starts with a general discussion. This is then followed by \textit{\nameref{propagation}} discussion. The last two sections are discussions about \textit{\nameref{sss}} and the \textit{\nameref{methev}}.}
