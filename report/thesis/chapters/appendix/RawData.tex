\chapter{Raw Data}
\label{appendix:raw}
In this appendix are tables containing row data not included in the thesis presented. These tables are Table \ref{TimeTable} and \ref{MemoryTable} which contains average, min and max values from executing overhead performance benchmarks.
