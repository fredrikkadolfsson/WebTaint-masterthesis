\chapter{Raw Data}
\label{appendix:raw}
This appendix consist of tables containing raw data which possibly not included in the thesis. These are Table \ref{TimeTable} and \ref{MemoryTable} and contains average, min and max values from executing overhead performance benchmarks.
