\chapter{Raw Data}
\label{appendix:raw}
In this appendix are tables containing raw data which might not be included in the thesis. These tables are Table \ref{TimeTable} and \ref{MemoryTable} which contains average, min and max values from executing overhead performance benchmarks.
