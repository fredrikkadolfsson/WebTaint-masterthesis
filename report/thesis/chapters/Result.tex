\chapter{Result}
\label{Result}
\textit{This chapter presents the evaluation results. Appendix \ref{appendix:raw} contains complemented data and metrics which will not be shown in the chapter. However, the chapter starts with exposing the results of the \textit{\nameref{Applications}} evaluation. This follows by results presented from the \textit{\nameref{Performance}} evaluation.}
