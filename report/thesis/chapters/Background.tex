...
\textcite{Wilander2009, Johnsson2009} created 2009 a blog post each in a synchronous manner where they together introduce the concept of Domain-Driven Security to the public. They describe Domain-Driven Security as the intersection between Domain-Driven Design and application security. Domain-Driven Security focuses on the importance of creating and maintaining domain models which reflect the product correctly. It is also essential that validations conduct correctly in the constructors of value objects, therefore preventing propagation of erroneous data \parencite{Wilander2009, Johnsson2009, Arnor2016, Stendahl2016}.



\todo[inline]{Todo: Utveckla }
