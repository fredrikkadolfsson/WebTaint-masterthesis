...
There are restrictions to instrumenting classes during runtime. Classes needed for the Java Virtual Machine need transformation before executing the Java application. This is because these classes load before the instrumentation agent. These classes are the content of the base Java Runtime Environment in the rt.jar.
