...
\textit{This section describes the conduction of the benchmarking of the implemented dynamic taint tracker. The chapter starts with a description of the \textit{\nameref{TestEnvironment}} followed by a detailed description about the \textit{\nameref{Benchmarking}}.}
