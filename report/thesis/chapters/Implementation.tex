...
This Chapter presents the fundamental parts in the process of implementing the Dynamic Taint Tracker. The chapter starts with a section describing the \textit{\nameref{Policies}} of the tool. This section is then followed by \textit{\nameref{SoftwareArchitecture}}.
