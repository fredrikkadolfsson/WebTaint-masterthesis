...
\todo[inline]{Todo: Skapa en bild som illustrerar achitecturen på applicationen. Förklara propageringslokien ordentligt. }

\todo[inline]{Todo: Uppdatera till senaste (SISTA SOM GÖRS)}
\textit{This chapter presents the fundamental parts of the implementation process of the dynamic taint tracker. The chapter starts with a section describing \textit{\nameref{Policies}} enforced by the application. This section is then followed by \textit{\nameref{SoftwareArchitecture}}.}
