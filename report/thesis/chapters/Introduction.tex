...
\label{Introduction}
\todo[inline]{Todo: Lägg till security exempel, hart bleed?. Lägg till att mycket är online services. Föra TT: Domain hantera både untrusted och trusted data. Finns olika lösningar för att lösa information flow control. Requirements!?!? Sustainabilities?}
